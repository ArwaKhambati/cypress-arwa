...
describe('Login Functionality Tests', () => {
    ...
    it('should login using Tag Scan', () => {
      loginPage.performTagScanLogin();
      //loginPage.assertLoginSuccess();
    });


   /*it('should login using CexTool credentials', () => {
        loginPage.performCexToolLogin();
        cy.log('✅ Test Passed: CexTool login performed successfully');
        loginPage.assertLoginSuccess();
        cy.log('✅ Test Passed: CexTool login performed successfully');
    });*/

    /*it('should login using Webuy credentials', () => {
      loginPage.performWebuyLogin();
      loginPage.assertLoginSuccess();
    });*/
});

it('TagScan.js', function() {
  cy.visit('https://uat-mepos2022.cex.webuy.dev/v2/#/')
  
});

it('kiwitag.js', function() {
